...
public class Server extends UnicastRemoteObject implements Server_itf{
    private static Map<String,Integer> nom_entier; 
    private static Map<Integer,ServerObject> entier_object; 
    ...
    public Object donneObjet(int id) throws RemoteException {
